...
libtheora: libogg
	cd libtheora* && \
		env CPPFLAGS='-I../libogg-1.3.2/include' LDFLAGS='-L../libogg-1.3.2/src/.libs' sh ./configure --disable-shared && \
		make
